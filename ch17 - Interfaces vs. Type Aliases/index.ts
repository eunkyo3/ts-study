...
// 위 두 구문은 동일한 구문입니다.
// 그러나 타입 별칭과 인터페이스 사이에는 몇 가지 중요한 차이점이 있습니다.
// 인터페이스는 속성 증가를 위한 병합(Merge) 할 수 있습니다.

// 일반적으로 인터페이스에서 타입스크립트 타입 검사기가 더 빨리 작동한다고 알려져 있습니다.
// 인터페이스는 타입 별칭이 하는 것처럼 새로운 객체 리터럴의 동적인 복사 붙여넣기 보다 내부적으로 더 쉽게 캐시할 수 있는 명명된 타입을 선언합니다.
...
// - 메서드 구문은 readonly로 선언할 수 없지만, 속성은 가능합니다.
